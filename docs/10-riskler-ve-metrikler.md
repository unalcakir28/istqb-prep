...
|---|---|:--:|:--:|---|
| **R-01** | **Telif ihlali iddiası** — ISTQB, LO kodları/başlıkları alıntımıza bile itiraz eder | D | **Y** | Tüm sorular özgün (K-1); ticari değil (K-2); her yerde kaynak gösterimi (K-3); yazılı izin başvurusu (K-5). İtiraz gelirse alıntıları kaldırıp yalnızca kendi metinlerimizle devam edebilecek şekilde veri modeli hazırlanır. |
