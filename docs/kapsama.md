...
24 soru · sinavda 8 soru · 14 ogrenme hedefi

| LO | K | Soru | | Hedef metni |
|---|:--:|--:|---|---|
| `FL-1.1.1` | K1 | 2 | `████████····` | Genel test hedeflerini tanımlamak |
| `FL-1.1.2` | K2 | 2 | `████████····` | Test ile hata ayıklamanın farklarını belirtmek |
| `FL-1.2.1` | K2 | 2 | `████████····` | Örnekler vererek yazılım testinin neden gerekli olduğunu açıklamak |
| `FL-1.2.2` | K1 | 2 | `████████····` | Yazılım testi ve kalite güvence arasındaki ilişkiyi anımsamak |
| `FL-1.2.3` | K2 | 3 | `████████████` | Kök neden, insan hatası, hata ve arıza arasındaki farkı ayırt etmek |
| `FL-1.3.1` | K2 | 4 | `████████████` | Yedi test prensibini açıklamak |
| `FL-1.4.1` | K2 | 2 | `████████····` | Farklı test aktivitelerini ve ilgili görevleri açıklamak |
| `FL-1.4.2` | K2 | 1 | `████········` | Proje bağlamının test süreci üzerindeki etkisini açıklamak |
| `FL-1.4.3` | K2 | 1 | `████········` | Test aktivitelerini destekleyen test çalışma ürünlerini ayırt etmek |
| `FL-1.4.4` | K2 | 1 | `████········` | İzlenebilirliğin sağlanmasının önemini açıklamak |
| `FL-1.4.5` | K2 | 1 | `████········` | Test etme sürecindeki farklı rolleri karşılaştırmak |
| `FL-1.5.1` | K2 | 1 | `████········` | Test etme sürecinde gerekli genel becerilere örnekler vermek |
| `FL-1.5.2` | K1 | 1 | `████········` | Tüm ekip yaklaşımının avantajlarını hatırlamak |
| `FL-1.5.3` | K2 | 1 | `████········` | Testin bağımsızlığının yararlarını ve sakıncalarını açıklamak |

### Bolum 2 — Yazılım Geliştirme Yaşam Döngüsü Boyunca Test

19 soru · sinavda 6 soru · 10 ogrenme hedefi

| LO | K | Soru | | Hedef metni |
|---|:--:|--:|---|---|
| `FL-2.1.1` | K2 | 2 | `████████····` | Seçilen yazılım geliştirme yaşam döngüsünün test üzerindeki etkisini açıklamak |
| `FL-2.1.2` | K1 | 1 | `████········` | Tüm yazılım geliştirme yaşam döngüsü için geçerli olan iyi test uygulamalarını hatırlamak |
| `FL-2.1.3` | K1 | 1 | `████········` | Geliştirmeye yönelik önce-test-et yaklaşımlarının örneklerini hatırlamak |
| `FL-2.1.4` | K2 | 2 | `████████····` | DevOps'un test üzerinde nasıl bir etkisi olabileceğini özetlemek |
| `FL-2.1.5` | K2 | 2 | `████████····` | Shift-left’i açıklamak |
| `FL-2.1.6` | K2 | 1 | `████········` | Geçmişe dönük verilerin süreç iyileştirmesi için nasıl bir mekanizma olarak kullanılabileceğini açıklamak |
| `FL-2.2.1` | K2 | 3 | `████████████` | Farklı test seviyelerini ayırt etmek |
| `FL-2.2.2` | K2 | 3 | `████████████` | Farklı test çeşitlerini ayırt etmek |
| `FL-2.2.3` | K2 | 2 | `████████····` | Onaylama testleri ve regresyon testlerini birbirinden ayırmak |
| `FL-2.3.1` | K2 | 2 | `████████····` | Bakım testleri ve tetikleyicilerini özetlemek |

### Bolum 3 — Statik Testler

12 soru · sinavda 4 soru · 8 ogrenme hedefi

| LO | K | Soru | | Hedef metni |
|---|:--:|--:|---|---|
| `FL-3.1.1` | K1 | 1 | `████········` | Statik test ile incelenebilecek iş ürünü çeşitlerini ayırt etmek |
| `FL-3.1.2` | K2 | 1 | `████········` | Statik testin önemini açıklamak |
| `FL-3.1.3` | K2 | 2 | `████████····` | Statik testler ve dinamik testler arasındaki farklılıkları karşılaştırıp kıyaslayabilmek |
| `FL-3.2.1` | K1 | 1 | `████········` | Erken ve sık paydaş geri bildiriminin faydalarını tanımlamak |
| `FL-3.2.2` | K2 | 2 | `████████····` | Gözden geçirme süreci faaliyetlerini özetlemek |
| `FL-3.2.3` | K1 | 2 | `████████····` | Gözden geçirme yapılırken ana rollere atanan sorumlulukları hatırlamak |
| `FL-3.2.4` | K2 | 2 | `████████····` | Farklı gözden geçirme çeşitlerini karşılaştırmak ve ayırt etmek |
| `FL-3.2.5` | K1 | 1 | `████········` | Başarılı bir gözden geçirmeye katkıda bulunan faktörleri hatırlamak |
...
6 soru · sinavda 2 soru · 2 ogrenme hedefi

| LO | K | Soru | | Hedef metni |
|---|:--:|--:|---|---|
| `FL-6.1.1` | K2 | 3 | `████████████` | Farklı test araçlarının test sürecini nasıl desteklediğini açıklamak |
| `FL-6.2.1` | K1 | 3 | `████████████` | Test otomasyonunun faydalarını ve risklerini hatırlamak |
